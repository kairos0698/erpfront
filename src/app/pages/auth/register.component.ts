        ...
        <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
          <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
            <div class="text-center mb-8">
              ...
              <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">¡Únete a SystemERP!</div>
              <span class="text-muted-color font-medium">Crea tu cuenta para comenzar</span>
            </div>

            <form (ngSubmit)="onSubmit()" #registerForm="ngForm">
              <div>
                <label for="username1" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Nombre de Usuario</label>
                <input 
                  pInputText 
                  id="username1" 
                  type="text" 
              ...
              <div>
                <label for="organizationName1" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Nombre de la Organización</label>
                <input 
                  pInputText 
